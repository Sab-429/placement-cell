...
import { ArrowLeft, Badge, Briefcase, Calendar, Clock, IndianRupee, MapPin, Send, Users } from "lucide-react";
                ...
                <div className="flex items-start gap-4 flex-1 min-w-0">
                  ...
                  {listing.recruiter?.logo_file_name ? (
                    <img
                      ...
                      alt="logo"
                      className="w-16 h-16 rounded-2xl object-contain border bg-white p-1.5 shrink-0"
                    />
                  ) : (
